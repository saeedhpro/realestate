            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.realestate.employee.store', $user->real_estate) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" required value="{{ $employee->name }}">
                                </div>
                            </div>
                        </div>
                        <hr />
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" class="form-control" disabled value="{{ $employee->email }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="address" class="form-control" rows="6">{{ $employee->address }}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr />
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="user-avatar">
                                        <img id="user-avatar" src="{{ $employee->avatar }}">
                                        <button class="btn btn-danger" id="delete-avatar">حذف آواتار</button>
                                    </div>
                                    @endif
                                    <label for="dropzone" class="bmd-label-static" style="width: 100%; margin-right: 10px; font-size: 16px;">آواتار جدید:</label>
                        ...
                        <hr />
                        <button id="storeEmployee" type="submit" class="btn btn-primary pull-right">ویرایش</button>
    ...
    <script>
        ...
        $(document).ready(()=>{
            ...
            $("#delete-avatar").on('click', (e) => {
                e.preventDefault();
                $.post({
                    url: '{{ route('dashboard.realestate.employee.avatar.delete',  ['id' => $employee->real_estate, 'eid' => $employee->id]) }}',
                    '_token': '{{ csrf_token() }}',
                    success: (response) => {
                        $('#user-avatar').src = '';
                    },
            ...
            $('#storeEmployee').on("click", function(e){
                ...
                $.post({
                    url: '{{ route('dashboard.realestate.employee.update', ['id' => $user->real_estate, '$eid' => $employee->id]) }}',
                    '_token': '{{ csrf_token() }}',
                    data: {
                        name: name,
                        email: email,
