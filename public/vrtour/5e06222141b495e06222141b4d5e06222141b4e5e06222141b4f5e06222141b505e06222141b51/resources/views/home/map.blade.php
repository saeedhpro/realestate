                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <form id="search-form" method="get">
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-12 col-md">
                                <input name="age" type="text" id="area-field" class="form-control" placeholder="سال ساخت">

                            </div>
                            <div class="col-12 col-sm-12 col-md">
                                <input name="room" type="text" id="area-field" class="form-control" placeholder="تعداد اتاق">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-12 col-sm-12 col-md">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-8 col-md-8 col-lg-8" style="text-align: right;">
                                                ...
                                                <div><p style="font-size: 13px" class="address"> <p style="font-size: 13px" class="btn-danger alerted">گران</p></div>
{{--                                                {{ $adv->priceLevel() }}--}}
