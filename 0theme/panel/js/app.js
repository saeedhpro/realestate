...
$(document).ready(function(){
	$('#add-post-cat-btn').click(function(e){
		e.preventDefault();
		$('#add-post-cat-box').toggleClass('hide');
	});
	$('#post-tags-list li').click(function(){
		$(this).remove();
	});
	$('#add-tag-btn').click(function(){
		var tag = $('#add-tag-input').val();
		// var li = '<li class="post-tag-li"><span><i class="fa fa-close" aria-hidden="true"></i></span><span>'+tag+'</span></li>';
		var li = '<li class="post-tag-li"><span>'+tag+'</span></li>';
		if(tag != ''){
			$(li).appendTo('#post-tags-list');
		}
	});
});
